...
Копия system/fwl/classifier/log_client.py под этот модуль
(MODULE_NAME другой) — так и задумано в logs/PROTOCOL.md: клиент
маленький, каждая независимая часть системы носит свою копию, а не
тянет общую зависимость.
...
не блокирует вызывающий код: событие просто теряется. Логирование не
должно быть причиной сбоя того, что логируется.
"""
