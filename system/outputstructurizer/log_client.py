...
фиксированный адрес демона логов. Если демон логов сейчас не запущен или
недоступен — send_log() не бросает исключение и не блокирует вызывающий
код: событие просто теряется. Логирование не должно быть причиной сбоя
того, что логируется.
"""
...
MODULE_NAME = "outputstructurizer"
...
def send_log(level: str, message: str, data: dict | None = None,
    ...
    try:
        ...
        pass  # логирование не должно ронять процесс — ни из-за сети, ни из-за странных типов в data
